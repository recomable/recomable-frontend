...
export const getRecommendation = (data, latitude, longitude, atmosphere, navigate) => async (dispatch) => {
    try {
        ...
        await axios({
            ...
            data: {"user_example": data, "latitude": latitude, "longitude": longitude, "atmosphere": atmosphere}
        }).then((res) => {
            dispatch({
